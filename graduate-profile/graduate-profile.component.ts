...
export class GraduateProfileComponent {
  jobs: any[] = []; // Assume jobs is an array
  ...
  constructor(
    private graduateDetailsService: GraduateDetailsService,
  ...
  async ngOnInit() {
    try {
      ...
      console.log('Jobs:', this.jobs); // Log the jobs to check the structure
      this.generateTable();
    } catch (error) {
